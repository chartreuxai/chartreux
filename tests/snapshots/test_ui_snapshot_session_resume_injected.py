...
class SnapshotTestAppWithInjectedMessages(BaseSnapshotTestApp):
    ...
    The injected middleware message between the two user turns must not appear
    ...
    def __init__(self) -> None:
        ...
        agent_loop.messages.extend([
            ...
            # Middleware-injected message — should be hidden
            LLMMessage(
                role=Role.user,
                content="<vibe_warning>Injected middleware message.</vibe_warning>",
                injected=True,
            ),
