...
from chartreux.cli.textual_ui.widgets.chat_input import paste_path
...
def _vision_config() -> ChartreuxConfigSchema:
    base = default_config()
    models = [
        ModelConfig(
            name="glm-5-2", provider="mistral", alias="glm-5-2", supports_images=True
        )
    ]
    providers = [
        ProviderConfig(
