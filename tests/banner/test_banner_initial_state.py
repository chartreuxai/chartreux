...
from chartreux.app_server.config import ConfigView, ThinkingLevel
from chartreux.app_server.models import MCPSourceStatus, MCPSourceSummary, MCPState
from chartreux.cli.textual_ui.widgets.banner.banner import (
    Banner,
    BannerState,
    _pluralize,
)
...
class TestBannerInitialState:
    def test_pluralize(self) -> None:
        ...
        assert _pluralize(2, "MCP server") == "2 MCP servers"
    ...
    def test_format_meta_counts(self) -> None:
        ...
        banner.state = BannerState(
            models_count=2, mcp_servers_enabled=1, mcp_servers_total=2, skills_count=5
        )
