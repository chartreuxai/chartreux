...
from chartreux.app_server import stdio
from chartreux.app_server._runtime import HarnessServer, RootOpenRequest
    ...
    input_messages = [
        {
            ...
            "params": {
                ...
                "capabilities": {"callbackKinds": ["user_input"]},
            },
        },
...
def test_stdio_session_start_maps_agent_config_workdir_to_runtime_cwd() -> None:
    ...
    params = SessionStartParams.model_validate(input_messages[2]["params"])
    captured.append(
        RootOpenRequest(
            ...
            client_capabilities=ClientCapabilities(client_tools=["terminal"]),
        )
    )
