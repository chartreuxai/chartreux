...
from chartreux.app_server.models import SessionTitleUpdatedNoticeDetail
from chartreux.core.events import SessionTitleUpdatedEvent
...
def _controller(session_id: str, services: _RecordingServices) -> Any:
    controller: Any = object.__new__(SessionRuntimeControllerImpl)
