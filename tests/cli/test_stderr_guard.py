...
_FORCE_ACTIVE = patch("chartreux.cli.stderr_guard._is_stderr_a_tty", return_value=True)
...
class TestStderrGuard:
    ...
    def test_noop_when_stderr_is_not_a_tty(self) -> None:
        original_stderr = sys.stderr
        with patch("chartreux.cli.stderr_guard._is_stderr_a_tty", return_value=False):
            with stderr_guard():
                assert sys.stderr is original_stderr
