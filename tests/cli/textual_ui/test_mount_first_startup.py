...
from chartreux.app_server.events import StatsUpdated
from chartreux.app_server.models import AgentStatsSnapshot, ConfigIssue
...
async def test_compose_yields_main_ui_when_no_session() -> None:
    ...
    app = build_test_chartreux_app(app_server=_blocking_starter)
