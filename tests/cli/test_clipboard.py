...
@patch("chartreux.ui.clipboard.copy_to_clipboard", return_value=True)
...
def test_copy_selection_to_clipboard_multiple_widgets(mock_app: MagicMock) -> None:
    ...
    with patch(
        "chartreux.ui.clipboard.copy_to_clipboard", return_value=True
...
@patch("chartreux.ui.clipboard.copy_to_clipboard", return_value=False)
...
@patch("chartreux.ui.clipboard._copy_osc52")
@patch("chartreux.ui.clipboard._copy_native")
...
@patch("chartreux.ui.clipboard._is_ssh_session", return_value=False)
@patch("chartreux.ui.clipboard._copy_osc52")
@patch("chartreux.ui.clipboard._copy_native", return_value=True)
...
@patch("chartreux.ui.clipboard._is_ssh_session", return_value=False)
@patch("chartreux.ui.clipboard._copy_osc52", side_effect=OSError("no tty"))
@patch("chartreux.ui.clipboard._copy_native", return_value=True)
...
@patch("chartreux.ui.clipboard._is_ssh_session", return_value=False)
@patch("chartreux.ui.clipboard._copy_osc52")
@patch("chartreux.ui.clipboard._copy_native", return_value=False)
...
@patch("chartreux.ui.clipboard._is_ssh_session", return_value=False)
@patch("chartreux.ui.clipboard._copy_osc52")
@patch("chartreux.ui.clipboard._copy_native", side_effect=RuntimeError("unavailable"))
...
@patch("chartreux.ui.clipboard._is_ssh_session", return_value=True)
@patch("chartreux.ui.clipboard._copy_osc52")
@patch("chartreux.ui.clipboard._copy_native")
