...
Defaults to scanning ``chartreux/``. Exits 0 (informational); pass ``--check``
...
DEFAULT_SCAN_ROOT = REPO_ROOT / "chartreux"
...
RUFF_TIMEOUT = 120  # seconds; ruff on chartreux/ finishes in well under this
...
def main(argv: list[str]) -> int:
    ...
    parser.add_argument(
        "paths", nargs="*", help="Files or directories to scan (default: chartreux/)."
    )
    parser.add_argument(
        "--check",
        action="store_true",
