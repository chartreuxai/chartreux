...
from chartreux.ui.widgets.braille_renderer import render_braille_styled
...
class PetitChat(Static):
    ...
    def compose(self) -> ComposeResult:
        yield Static(
            render_braille_styled(self._dots, WIDTH, HEIGHT, EYE_CELLS, EYE_COLOR),
            classes="petit-chat",
        )
