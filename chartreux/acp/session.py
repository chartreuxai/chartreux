...
from chartreux.acp.commands.registry import AcpCommandRegistry
...
class AcpSession:
    ...
    def set_prompt_task(self, task: asyncio.Task[Any]) -> None:
        self._prompt_task = task

    def clear_prompt_task(self, task: asyncio.Task[Any]) -> None:
