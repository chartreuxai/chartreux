...
from chartreux.core.llm_models import AvailableTool, LLMMessage, Role, StrToolChoice
...
class ResolvedToolCall(BaseModel):
    ...
    def args_dict(self) -> dict[str, Any]:
        """Return only arguments supplied by the model for invocation revalidation."""
        return self.validated_args.model_dump(exclude_unset=True)
